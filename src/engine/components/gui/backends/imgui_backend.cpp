...
void ImGuiBackend::drawDeathScreen() {
    ImGuiIO& io = ImGui::GetIO();
...
void ImGuiBackend::drawConsolePanel() {
    ImGuiIO& io = ImGui::GetIO();
...
MainMenuInterface &ImGuiBackend::mainMenu() {
    return mainMenuView;
}

const MainMenuInterface &ImGuiBackend::mainMenu() const {
    return mainMenuView;
}
